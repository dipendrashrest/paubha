...
This package is **not** installed from npm by apps. Consumers copy files via [`npx paubha add`](https://paubha.vercel.app/docs/cli) from the hosted registry JSON.
...
Homepage / registry base: `https://paubha.vercel.app`.
