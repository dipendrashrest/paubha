...
project. Default registry: `https://paubha.vercel.app/r`.
...
Components are served as JSON from `https://paubha.vercel.app/r/[name].json`, following the
...
```json
{
  ...
  "name": "paubha",
  "homepage": "https://paubha.vercel.app",
  "items": [
    {
      "name": "button",
      "type": "registry:ui",
